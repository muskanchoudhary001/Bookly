...
const CreateBooks = () => {
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-4'>Create a New Book Here</h1>
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <div className='my-4'>
          <label className='text-xl my-4 text-gray-500'>publishYear</label>
          <input type="text"
            value={publishYear}
        ...
        <div className='my-4'>
          <label className='text-xl my-4 text-gray-500'>noOfCopies</label>
          <input type="text"
            value={noOfCopies}
